...
// Created  : 15-jan-2024
//
// Description: CVA6 first pass decoder modified for use with Marian. Added
// support for vector cryto instructions. Original description maintained
// below:
// -----------------------------------------------------------------------------
...
//  - exit_o: Exit signal used for simulation to indicate end of execution
//  - scan_enable_i: Scan enable
//  - scan_data_i: Scan data
//  - uart_rx_i: UART Rx
//
// Outputs:
//  - scan_data_o: Scan data out
//  - uart_tx_o: UART Tx
//
// Revision History:
...
import rvv_pkg::*; (
  ...
  always_comb begin
    ...
    case (instr.i_type.opcode)
      ...
      // OP-P (0x77) Vector Crypto Instruction
